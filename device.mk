...
#Recovery
PRODUCT_COPY_FILES += \
	device/motorola/albus/rootdir/etc/fstab.qcom:$(TARGET_COPY_OUT_RAMDISK)/fstab.qcom
...
#Vendor fstab
PRODUCT_COPY_FILES += \
	device/motorola/albus/rootdir/etc/fstab.qcom:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.qcom
